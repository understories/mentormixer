    ...
    <footer className="w-full mt-auto border-t border-gray-200 bg-white">
      <div className="flex items-center justify-between max-w-2xl mx-auto p-4 min-h-[60px]">
        <a
          ...
          className="flex items-center gap-2 text-sm text-text-light hover:text-text transition-colors min-h-[44px] touch-manipulation"
        ...
        >
          <span>🌱</span>
          <span>NS March 2026 Cohort Ask & Offer Board</span>
          <span>→</span>
        </a>
      </div>
    </footer>
